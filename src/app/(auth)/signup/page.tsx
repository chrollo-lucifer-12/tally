...
const SignupPage = () => {
    return <div className={"w-full max-w-[320px]"}>
        <header className={"flex flex-col gap-y-10 justify-center"}>
            ...
            <span>
            <p className={"text-black text-[24px] font-[700]"}>Create your Tally account</p>
            <p className={"text-gray-5 text-[16px] font-[600] mt-10px leading-[1.25]"}>Get started with the simplest way to create forms.</p>
            </span>
        </header>
        ...
        <section className={"flex flex-col gap-y-4 mt-10"}>
            <CustomInput name={"name"} type={"email"} label={"Email"}/>
            <CustomButton title={"Continue"} cn={"bg-black text-white hover:text-white hover:bg-gray-900"} />
        </section>
