...
const HeroBanner = () => {
    return <div className={"w-full mt-32 flex flex-col items-center justify-center"}>
        <Image src={"/squiggles.png"} alt={"squiggles"} width={100} height={100} className={"absolute z-10 left-30 top-[190px]"}/>
        <h1 className={"relative mb-12 leading-none -tracking-[2px] text-black text-center text-[65px] font-[1000]"}>The simplest way to create forms</h1>
