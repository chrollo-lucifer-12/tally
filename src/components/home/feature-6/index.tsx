...
const Feature5 = () => {
    return <section className="mt-64 flex justify-between items-center  gap-y-10 px-4 sm:px-10 md:px-20 lg:px-[120px]">
        <Image src={"/particles-left.png"} alt={"faces"} width={100} height={600} className={"hidden md:block"} />
        <div>
            <div className={"sm:w-[700px] w-[300px] flex flex-col gap-y-10 items-center justify-center"}>
        ...
        <Image src={"/particles-right.png"} alt={"faces"} width={100} height={600} className={"hidden md:block"} />
    </section>
}
